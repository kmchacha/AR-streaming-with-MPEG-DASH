...
for the HEVC project. It applies to version 16.24
of the software.
\end{abstract}
...
%\ShortOption{\None} &
\Default{true} &
Enables or disable referencing future frames in the GOP based temporal filter. Can be used for low delay configuration.
\\
